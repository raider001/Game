...
{
    public class MarchingCubesTest3 : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            grid.Point[3, 2, 3] = new Point(PointType.SOLID, 1);
            grid.Point[1, 2, 3] = new Point(PointType.SOLID, 1);
            grid.Point[3, 2, 1] = new Point(PointType.SOLID, 1);
            
            grid.Point[2, 2, 1] = new Point(PointType.SOLID, 1);
            grid.Point[1, 2, 2] = new Point(PointType.SOLID, 1);
            grid.Point[1, 2, 3] = new Point(PointType.SOLID, 1);
            grid.Point[3, 2, 1] = new Point(PointType.SOLID, 1);
