...
{
    public class MarchingCubesTest2 : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            grid.Point[2, 1, 2] = new Point(PointType.SOLID, 1);
            grid.Point[2, 2, 2] = new Point(PointType.SOLID, 1);
            grid.Point[2, 3, 2] = new Point(PointType.SOLID, 1);
